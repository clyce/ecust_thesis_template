...
\setlength{\itemsep}{-0.4ex}
	\bibitem{survey} R Angles, C Gutierrez.  Survey of Graph Database Models[J]. \journal{Computer Science Department, Universidad de Chile}. 2005,10
	\bibitem{GSFC} 孙延凡, 陈红.  GSFC——基于图结构的Free Cube 存储方法[J]. \journal{计算机研究与发展}. 2004,03
	\bibitem{Research} 丁悦,张阳,李战怀,王勇.  图数据挖掘技术的研究与进展[J]. \journal{计算机应用}. 2011,09
	\bibitem{Store} 周海岩.  图的关联链式存储结构[J]. \journal{计算机研究与发展}. 1997,09
	...
	\bibitem{cluster}谢岳山, 樊晓平, 廖志芳, 尹红练, 罗浩.  一种基于图论的加权聚类融合算法[J]. \journal{计算机应用研究}. 2012,11
	\bibitem{path}吴京, 刘露, 李骏.  一种面向多制式路径规划的网络模型[J]. \journal{国防科技大学学报}. 2009,05
	\bibitem{choose}王钊, 王晓, 刘斌.  基于格的多信任域认证路径的选择算法[J]. \journal{安徽科技学院学报}. 2010,03
